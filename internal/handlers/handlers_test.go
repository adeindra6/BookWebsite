...
var theTests = []struct {
	...
	/*
		{"post-search-availability", "/search-availability", "POST", []postData{
			{key: "start", value: "2020-07-23"},
			{key: "end", value: "2021-07-23"},
		}, http.StatusOK},
		...
		{"make reservation post", "/make-reservation", "POST", []postData{
			{key: "first_name", value: "Rabbid"},
			{key: "last_name", value: "Bwabwa"},
			{key: "email", value: "rabbid@gmail.com"},
...
func TestRepository_PostReservation(t *testing.T) {
	...
	reqBody = fmt.Sprintf("%s&%s", reqBody, "first_name=Rabbid")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "last_name=BwaBwa")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "email=rabbid@gmail.com")
	...
	postedData.Add("first_name", "Rabbid")
	postedData.Add("last_name", "BwaBwa")
	postedData.Add("email", "rabbid@gmail.com")
	postedData.Add("phone", "123456")
	...
	reqBody = "start_date=2050-01-01"
	reqBody = fmt.Sprintf("%s&%s", reqBody, "end_date=2050-01-02")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "first_name=R")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "last_name=BwaBwa")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "email=rabbid@gmail.com")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "phone=123456")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "room_id=1")
