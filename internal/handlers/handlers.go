...
import (
	...
	"github.com/adeindra6/BookWebsite/internal/driver"
	"github.com/adeindra6/BookWebsite/internal/forms"
	"github.com/adeindra6/BookWebsite/internal/helpers"
	...
	"github.com/adeindra6/BookWebsite/internal/repository/dbrepo"
...
// PostReservation handlers the posting of a reservation
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	msg := models.MailData{
		...
		From:     "reservation-no-reply@gmail.com",
			...
			if val, ok := curMap[name]; ok {
				...
				if val > 0 {
					if !form.Has(fmt.Sprintf("remove_block_%d_%s", x.ID, name)) {
						...
						err := m.DB.DeleteBlockRoomByID(value)
						if err != nil {
							log.Println(err)
						}
					}
